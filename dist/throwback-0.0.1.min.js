 ...
 * Licensed MIT
 */
(function(a){"use strict";var b={};b.Util={uuid:function(){return(Math.PI*Math.max(.01,Math.random())).toString(36).substr(2)}};var c=b.Base=function(){};c.extend=function(a,c){var d,e,f,g;return e=this,d=a&&a.hasOwnProperty("constructor")?a.constructor:function(){return e.apply(this,arguments)},g=b.jQuery,g.extend(d,e,c),f=function(){this.constructor=d},f.prototype=e.prototype,d.prototype=new f,d.__super__=e.prototype,a&&g.extend(d.prototype,a),d},a&&(b.jQuery=a.noConflict()),b.Bootstrap=c.extend({constructor:function(){}}),b.Timer=c.extend();var d;b.Game=c.extend({constructor:function(a){var c=b.jQuery.extend({},a);this.stage=c.stage||new b.Stage},setup:function(a){d=a},start:function(){d()}});var e,f,g=b.Node=c.extend({addChild:function(a){var b;a.parent=this,this.children.push(a),b=this.stage,b&&b.attach(a)},constructor:function(){var a;this.el=a=document.createElement("div"),this.parent=null,this.children=[],this.matrix=f(),this.position=[0,0,1],b.jQuery(a).css({position:"absolute",top:0,left:0})},setPosition:function(a,b){this.position=numeric.dot(e(a,b),this.position)}});f=function(){return[[1,0,0],[0,1,0],[0,0,1]]},e=function(a,b){return[[1,0,a],[0,1,b],[0,0,1]]},b.Entity=g.extend(),b.Group=g.extend(),b.Layer=g.extend(),b.Scene=g.extend();var h;b.Stage=g.extend({attach:function(a){var c,d;a.stage||(a.stage=d=this,b.jQuery(a.el).appendTo(this.el),c=a.children,c.length&&c.forEach(function(a){d.attach(a)}))},constructor:function(a){var c=b.jQuery.extend({},a);g.call(this),this.el=c.el||this.el,h.call(this,c.container)}}),h=function(a){b.jQuery(this.el).addClass("stage").appendTo(a||"body")},b.Animation=c.extend({constructor:function(a){var b=this;this.sprite=a,a.async.done(function(){b.sequence([0])})},getFrameCount:function(){var a=this.frames;return a?a.length:this.sprite.getFrameCount()},sequence:function(a){if(!this.sprite.verifyFrames(a))throw new Error("frames out of bounds");this.frames=a}});var i,j,k;i={},b.Sprite=c.extend({constructor:function(a){this.async=new b.jQuery.Deferred,this.options={},"string"==typeof a?this.setImage(a):this.config(a)},config:function(a){b.jQuery.extend(this.options,a),a.img&&this.setImage(a.img)},get:function(a){return this.options[a]},getFrameCount:function(){var a,b,c,d;return a=this.get("width")||0,b=this.get("height")||0,c=this.get("frameWidth")||1,d=this.get("frameHeight")||1,Math.floor(a/c)*Math.floor(b/d)},setImage:function(a){var b;b=i[a],b?(this.image=b,this.async.resolve()):this.image=i[a]=j(a,this.async),k.call(this)},verifyFrames:function(a){var b,c;return b=Math.min.apply(Math,a),c=Math.max.apply(Math,a),b>=0&&c<=this.getFrameCount()-1}}),k=function(){var a=this,c=this.image;c&&this.async.done(function(){var d,e,f;d=b.jQuery(c),e=a.get("width")||d.width(),f=a.get("height")||d.height(),a.config({width:e,height:f,frameWidth:a.get("frameWidth")||e||1,frameHeight:a.get("frameHeight")||f||1})})},j=function(a,b){var c=new Image;return c.src=a,c.onLoad=c.onError=function(){b.resolve()},c};var l=b.Audio=c.extend();b.Music=l.extend(),b.Sound=l.extend(),"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports?exports=module.exports=b:this.Throwback=b}).call(this,this.jQuery);
